            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('edit_feature_card', $item->id) }}" class="btn rounded-pill btn-info waves-effect waves-light">Edit</a>

                            <a href="{{ route('delete_feature_card', $item->id) }}" class="btn rounded-pill btn-danger waves-effect waves-light" id="delete">Delete
                            </a>
