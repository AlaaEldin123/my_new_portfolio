...
@endsection --}}
    <div class="row">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Table /</span> Social Media Icons</h4>
        <div class="card">
            {{-- <a href=""class="btn rounded-pill btn-info waves-effect waves-light">Info</a> --}}

            <div class="d-flex justify-content-end mt-3">
                <a href="{{ route('add_social_media_banner_icon') }}"
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        @foreach ($banner_icons as $item)
                            <tr>
                                ...
                                <td>{{ $item->link }}</td>
                                <td>
                                    <a href="{{ route('edit_social_media_banner_icon', $item->id) }}"
                                        class="btn rounded-pill btn-info waves-effect waves-light">Edit</a>

                                    <a href="{{ route('delete_social_media_banner_icon', $item->id) }}"
