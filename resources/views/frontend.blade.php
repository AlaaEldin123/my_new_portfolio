                                    ...
                                    <div class="rn-blog" data-bs-toggle="modal"
                                        ...
                                        <div class="inner">
                                            ...
                                            <div class="content">
                                                ...
                                                <h4 class="title"><a href="javascript:void(0)">The services provide
                                                        for design
                                                        <i class="feather-arrow-up-right"></i></a></h4>
                                            </div>
                                        </div>
                    ...
                    <div class="modal fade" id="exampleModalCenters" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-news" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <img src="{{ asset('frontend/assets/images/blog/blog-big-01.jpg') }}"
                                        alt="news modal" class="img-fluid modal-feat-img">
